...
public class Reporting extends TestListenerAdapter {
    ...
    public void onStart(ITestContext testContext)
    {
        ...
        String repName="Orchestra-Test-Report-"+timeStamp+".html";
        ...
        extent.setSystemInfo("user","Anuk");

        htmlReporter.config().setDocumentTitle("Qmatic Orchestra Project"); // Tile of report
    ...
    public void onTestFailure(ITestResult tr)
    {
        ...
        String screenshotPath=System.getProperty("user.dir")+"/Screenshots/"+tr.getName()+screenShotName;
